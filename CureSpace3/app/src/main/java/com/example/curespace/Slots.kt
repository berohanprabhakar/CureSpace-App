...
class Slots : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                Toast.makeText(this@Slots, "Please enter valid pin code", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun getAppointments(pinCode: String, date: String) {
        ...
        val queue = Volley.newRequestQueue(this@Slots)
        ...
        val request =
            ...
            JsonObjectRequest(Request.Method.GET, url, null, { response ->
                ...
                { error ->
                    ...
                    Toast.makeText(this@Slots, "Fail to get response", Toast.LENGTH_SHORT).show()
                })
